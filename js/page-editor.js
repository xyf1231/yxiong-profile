...
const pageSchemas = {
  ...
  profile: {
    ...
    cssGroups: [
      ...
      group("代表论文卡片", [
        rangeField("--profile-publication-padding-top", "卡片上边距", 0, 120, 1, "px", "--profile-publication-padding-top-mobile"),
        rangeField("--profile-publication-padding-bottom", "卡片下边距", 0, 120, 1, "px", "--profile-publication-padding-bottom-mobile"),
        rangeField("--profile-publication-index-offset-top", "序号距上边缘", -40, 40, 1, "px", "--profile-publication-index-offset-top-mobile"),
        rangeField("--profile-publication-index-offset-left", "序号距左边缘", -40, 40, 1, "px", "--profile-publication-index-offset-left-mobile"),
